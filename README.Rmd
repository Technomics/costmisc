...
The *costverse* began as an internal project by [Technomics Employee Owners](https://www.technomics.net/) to develop a set of tools that we actually want to use, to solve problems we are actually working on. While aspects of the project still remain internal, the following packages are currently available to the public. You are free to use them under the [GPLv3](https://www.gnu.org/licenses/gpl-3.0.en.html) - all that we ask is to please cite us as the authors.
